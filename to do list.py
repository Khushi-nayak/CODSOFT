...
def delete_task():   # using the try-except method  
    try:  
...
if __name__ == "__main__":  
    ...
    # setting the background color to #fbfle3
...
header_frame = tk.Frame(guiWindow, bg = "#F8EEEC")
functions_frame = tk.Frame(guiWindow, bg = "#F8EEEC")  
listbox_frame = tk.Frame(guiWindow, bg = "#F8EEEC")  
...
header_label = ttk.Label(  header_frame,text = " To-Do List",  font = ("Gill Sans MT Bold Italic", "30"),  background = "#F8EEEC",  foreground = "#8B4513")

    # using the pack() method to place the label in the application  
header_label.pack(padx = 10, pady = 10)  

    # defining another label using the ttk.Label() widget  
task_label = ttk.Label( functions_frame,  text = "Enter the Task:",  font = ("Consolas", "11", "bold"),  background = "#F8EEEC",  foreground = "#000000"  )  
